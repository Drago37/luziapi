...
final readonly class GetCustomerDirectoryHandler
{
    ...
    /** @param array<string, \LuziApi\Shop\Domain\Customer\CustomerBilling> $overrides */
    private static function overrideFor(CustomerProfile $profile, array $overrides): ?\LuziApi\Shop\Domain\Customer\CustomerBilling
    {
        foreach ($profile->identityIds as $identityId) {
