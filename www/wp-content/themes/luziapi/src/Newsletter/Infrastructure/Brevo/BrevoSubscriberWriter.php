 ...
 * blacklists). Inscription DIRECTE, sans double opt-in. La clé API vit dans l'option
 * `sib_api_key_v3`. Après écriture, le cache de lecture de la liste est purgé pour que
 * la page « Abonnés » reflète immédiatement le changement.
 */
