...
.PHONY: help env up start stop restart down destroy build logs ps install fixtures wait \
        ...
        e2e-tracking-local e2e-vente-local e2e-receipt-local e2e-loyalty-local e2e-discount-local e2e-vente-loyalty-local e2e-loyalty-client-local e2e-prod e2e-prod-send
